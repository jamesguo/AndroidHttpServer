...
public abstract class NanoHTTPD {
    ...
    public void start() throws IOException {
		...
		// myServerSocket.bind((hostname != null) ? new
		// InetSocketAddress(hostname, myPort) : new InetSocketAddress(myPort));
				...
				asyncRunner.exec(new Runnable() {
					...
					public void run() {
						...
						try {
							...
							// When the socket is closed by the client, we throw
							// our own SocketException
